...
}:
{
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    "$menu" = "wmenu-run -p 'search: ' -M ebdbb2 -m 282828 -N 282828 -n ebdbb2 -S ebdbb2 -s 282828 -f 'VictorMono Nerd Font Bold 12' ";
    "$browser" = "firefox";
    "$zoomer" = "woomer";
    "$volume_control" = "pavucontrol";
    # "$clipboard" = "cliphist list | rofi -dmenu | cliphist decode | wl-copy";
    "$clipboard" =
      "cliphist list | wmenu -p 'clipboard: ' -M ebdbb2 -m 282828 -N 282828 -n ebdbb2 -S ebdbb2 -s 282828 -f 'VictorMono Nerd Font Bold 12' -l 10 | cliphist decode | wl-copy";
