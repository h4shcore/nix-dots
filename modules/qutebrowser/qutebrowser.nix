  ...
  programs = {
    qutebrowser = {
      ...
      extraConfig = ''
        ...
        c.fonts.tabs.selected = '14pt Terminess Nerd Font'
        c.fonts.tabs.unselected = '14pt Terminess Nerd Font'
        c.fonts.statusbar = '14pt Terminess Nerd Font'
        c.fonts.completion.entry = '14pt Terminess Nerd Font'
